...
# Throttle para sincronización de hoteles inactivos (no más de 1 vez por minuto)
_last_sync_time = 0
...
def _sync_si_necesario():
    """Sincroniza alertas de hoteles inactivos como máximo una vez por minuto."""
    global _last_sync_time
    import time
    ahora = time.time()
    if ahora - _last_sync_time >= _SYNC_COOLDOWN_SECONDS:
        _last_sync_time = ahora
